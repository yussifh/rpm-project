...
blood_glucose_mg_dl=glucose,
            skin_thickness_mm=round(18 + (uuid.uuid4().int % 12), 1),
            serum_insulin_mu_u_ml=round(60 + (uuid.uuid4().int % 120), 1),
            diabetes_pedigree_function=round(0.2 + (uuid.uuid4().int % 100) / 100.0, 3),

...
def build_patient_summary_pdf(data: ReportData) -> bytes:
    ...
    elements.append(
        Paragraph(
            ...
            "not replace, clinical judgment. All risk predictions come from a demonstration model trained "
            "on public research datasets (e.g. Pima Indians, Framingham Heart Study) and require clinical "
            "validation against the target patient population before real-world use.",
            styles["Italic"],
        )
    )
